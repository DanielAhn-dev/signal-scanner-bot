...
export default defineConfig(({ mode }) => {
  ...
  return {
    plugins: [react()],
    define: {
      // Do not expose server-side UI_READ_KEY to client bundles implicitly.
      'import.meta.env.VITE_UI_READ_KEY': JSON.stringify(readEnv('VITE_UI_READ_KEY')),
      ...
      'import.meta.env.VITE_SUPABASE_ANON_KEY': JSON.stringify(readEnv('VITE_SUPABASE_ANON_KEY', 'SUPABASE_ANON_KEY')),
