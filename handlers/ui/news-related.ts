...
const NICKNAME_PATTERNS: Array<{ pattern: RegExp; code: string; name: string }> = [
  ...
  { pattern: /\b삼전\b|삼성\s*전자/, code: '005930', name: '삼성전자' },
  { pattern: /\b하닉\b|하이닉스/, code: '000660', name: 'SK하이닉스' },
  { pattern: /\b네카오\b/, code: '035420', name: 'NAVER' },
  { pattern: /\b카카오\b/, code: '035720', name: '카카오' },
  { pattern: /\b네이버\b/, code: '035420', name: 'NAVER' },
  { pattern: /\b현차\b|현대\s*차/, code: '005380', name: '현대차' },
  { pattern: /\b엘전\b|LG\s*전자/, code: '066570', name: 'LG전자' },
  { pattern: /\b삼바\b|삼성\s*바이오/, code: '207940', name: '삼성바이오로직스' },
...
const SITE_SELECTORS: Record<string, string[]> = {
  ...
  'wowtv.co.kr': ['#article_body', '.article-body', '.article_txt'],
  'mbn.co.kr': ['#newsViewArea', '.news_cnt_detail_wrap', '.news_cnt_detail'],
  'kmib.co.kr': ['#articleBody', '.tx-article-content', '.view_con'],
  'heraldcorp.com': ['#articleText', '.article-text', '.news_body_area'],
  'hankyungtv.com': ['#newsViewContainer', '.article-view', '.news-content'],
  'sisajournal-e.com': ['#article-view-content-div', '.article-view-content-div', '.article_txt'],
  'jmagazine.joins.com': ['#article_body', '.article_body', '.articleBody'],
